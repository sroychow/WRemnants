...
from wremnants.datasets.datasetDict_2017_v9 import dataDictV9_2017
...
lumijson = f"{pathlib.Path(__file__).parent.parent}/data/Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt"

def getDatasets(maxFiles=-1, filt=None, excl=None, mode=None, base_path=None, nanoVersion="v9", 
        data_tag="TrackFitV722_NanoProdv2", mc_tag="2017test"):
    if not base_path:
        ...
        if hostname == "cmswmass2.cern.ch":
            ...
            base_path = "/scratchnvme/wmass/NANOV9/y2017" #temporary
