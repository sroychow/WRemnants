...
// Standalone code to make multiD histograms for the sagitta fit
  ...
  PairTuple muPair(unsigned int nSlot, const RVecF& Muon_pt, const RVecI& Muon_charge, const RVecF& Muon_eta, const RVecF& Muon_phi, const RVecF& Muon_dxy, const RVecF& Muon_dz, const RVecI& GenPart_status, const RVecI& GenPart_pdgId, const RVecI& GenPart_genPartIdxMother, const RVecF& GenPart_pt, const RVecF& GenPart_eta, const RVecF& GenPart_phi, const ROOT::VecOps::RVec<TRandom3*>& rGaus) {  
    bool isMC = (GenPart_status.size() == 0);
  ...
  PairTuple muPair(unsigned int nSlot, const RVecF& Muon_pt, const RVecI& Muon_charge, const RVecF& Muon_eta, const RVecF& Muon_phi, const RVecF& Muon_dxy, const RVecF& Muon_dz) {
    RVecI dummyI;
    RVecF dummyF;
    const ROOT::VecOps::RVec<TRandom3*> dummyG;
    return muPair(nSlot, Muon_pt, Muon_charge, Muon_eta, Muon_phi, Muon_dxy, Muon_dz, dummyI, dummyI, dummyI, dummyF, dummyF, dummyF, dummyG);
  }
